...
2. Binds alarm evidence to the originating camera and exact AI detection frame. New alarms persist the frame that produced the detection. Backend and frontend checks prevent evidence from another camera from being displayed.
