...
This build is rebased on the deployed event-situation persistent aggregation version, so its first/latest occurrence tracking, dedupe lifecycle and three-column review details are preserved.
