# River Watch capture and alarm-evidence link increment v5 (2026-07-23)
...
This build is rebased on the currently deployed 2026-07-20 channel-isolation/evidence version. It preserves channel isolation, evidence loading/error states, event first/latest occurrence tracking, dedupe lifecycle and three-column review details.
