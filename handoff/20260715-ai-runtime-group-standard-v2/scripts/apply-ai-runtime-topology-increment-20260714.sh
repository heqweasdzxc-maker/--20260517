...
BACKUP_DIR="$BACKUP_ROOT/ai-runtime-group-standard-v2-20260715-$STAMP"
STATE_FILE="$BACKUP_DIR/unit-state.tsv"
FILE_STATE="$BACKUP_DIR/file-state.tsv"
RECEIPT_DIR="$APP_DIR/logs/ops"
RECEIPT="$RECEIPT_DIR/ai-runtime-group-standard-v2-20260715-$STAMP.md"
...
log "River Watch AI runtime group-standard v2"
...
cat > "$RECEIPT" <<EOF
# AI runtime group-standard v2 receipt
